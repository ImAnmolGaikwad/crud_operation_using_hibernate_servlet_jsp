...
<body>
	...
	<div align="center"
		...
		<form action="editUser" method="post" style="">
		<input type="hidden" name="id" value="<%=user.getId()%>">
			<input type="text" name="name" class="form-control form-control-sm"
				placeholder="Name" value="<%=user.getName()%>" required ><br> <br> <input
				type="text" name="address" class="form-control form-control-sm"
				placeholder="Address" value="<%=user.getAddress()%>" required><br> <br> <input
				type="tel" name="phone" class="form-control form-control-sm"
				placeholder="Phone" value="<%=user.getPhone()%>" required><br> <br> <input
				type="submit" class="btn btn-primary" value="Update Person">
		</form>
	</div>
</body>
</html>